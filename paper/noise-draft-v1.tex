...
$P(\sall | \ssome) = \epsilon$, and $P(\ssome | \sall) = \delta$. For instance, states may be perceived differently because a large number of objects is involved (e.g., quantifiers and numerals) or because they are subjective or difficult to impossible to accurately derive from sensory information (e.g., adjectives).
...
pragmatically.  Similar results are obtained for increments in $k$ or $l$.
